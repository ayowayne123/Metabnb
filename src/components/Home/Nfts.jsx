...
function Nfts() {
  return (
    <div className='bg-pink-grad md:max-h-screen text-white'> 
    <div className='py-16 container grid  lg:grid-cols-[3fr,4fr] items-center overflow-hidden'>
        <div className='pb-5 lg:pb-0 flex flex-col justify-center gap-10 pr-[10%]'> 
