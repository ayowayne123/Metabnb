...
function Wallet({open,onClose}) {
    ...
    if(!open) return null
  return (
    <div onClick={onClose} className='fixed text-blacktext px-3 flex flex-col justify-center z-10 h-screen w-full bg-[#00000059] top-0 left-0 right-0 overflow-hidden'>
        <div onClick={(e) => {e.stopPropagation()}} className='place-self-center md:h-[328px] w-full md:w-[600px] bg-white rounded-xl py-6 '>
            <div className='px-8 '> 
            ...
            <span className='border-[#CFD8DC] border rounded-[12px] md:text-lg h-16 md:w-[536px] py-3 px-4 '>
