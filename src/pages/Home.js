...
function Home() {
  return (
    ...
    <div className='container'>
      <div>   <span className='block lg:hidden py-3 font-normal text-3xl md:text-4xl 2xl:text-hero-main xl:text-5xl xl:leading-5xl '> Rent a <span className='font-bold text-pinktext'>Place</span> away from <span className='font-bold text-pinktext'>Home
        ...
        <div className='pb-6 grid lg:grid-cols-2  w-full lg:h-[calc(100vh-6rem)] items-center text-blacktext'>
            ...
            <div className='row-start-1 lg:col-start-2 grid grid-cols-2  gap-2 w-full lg:pl-24  lg:pr-5 py-3 lg:py-16'>
