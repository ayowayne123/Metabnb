...
function Home() {
  return (
    ...
    <div className='container'>
        <div className='grid grid-cols-2 w-full h-[calc(100vh-6rem)] items-center text-blacktext'>
            <div className='flex flex-col text-left h-full w-full justify-center gap-12'> 
            <span className='font-normal 2xl:text-hero-main xl:text-5xl xl:leading-5xl '> Rent a <span className='font-bold text-pinktext'>Place</span> away from <span className='font-bold text-pinktext'>Home</span> in the <span className='font-bold text-pinktext'>Metaverse</span></span>
            <span className='text-2xl'> we provide you access to luxury and affordable houses in the metaverse, 
            ...
            <div className='grid grid-cols-2  gap-2 w-full pl-24  pr-5 py-16'>
